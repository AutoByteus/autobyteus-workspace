...
const toGraphqlResult = async (fieldName: string, loader: () => Promise<unknown> | unknown) => {
  try {
    return {
      data: {
...
export const executeSocraticMathGraphql: ApplicationGraphqlExecutor = async (request, context) => {
