...
import { buildConfiguredTeamRunLaunch, resolveConfiguredTeamLaunchProfile, } from "../vendor/application-backend-sdk.js";
...
const LESSON_TUTOR_TEAM_SLOT_KEY = "lessonTutorTeam";
...
const requireLesson = (context, lessonId) => withAppDatabase(context.storage.appDatabasePath, (db) => {
