...
export type ApplicationConfiguredLaunchProfile = ApplicationConfiguredAgentLaunchProfile | ApplicationConfiguredTeamLaunchProfile;
...
export type ApplicationResourceConfigurationIssueCode = "INVALID_RESOURCE_SELECTION" | "PROFILE_KIND_MISMATCH" | "PROFILE_UNSUPPORTED_BY_SLOT" | "TEAM_TOPOLOGY_CHANGED" | "PROFILE_MALFORMED";
...
export type ApplicationResourceConfigurationStatus = "READY" | "NOT_CONFIGURED" | "INVALID_SAVED_CONFIGURATION";
