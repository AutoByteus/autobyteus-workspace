...
export const getApplicationAgentTargetUrlSegments = (address) => {
    ...
    if (!memberAddress.startsWith("/"))
        throw new Error("Application agent memberAddress is required.");
...
//# sourceMappingURL=application-agent-target-url.js.map