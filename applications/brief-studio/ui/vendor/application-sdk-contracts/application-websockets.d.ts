...
export type ApplicationWebSocketRouteDefinition = {
    path: string;
    open: (request: ApplicationWebSocketRequest, session: ApplicationWebSocketSession, context: ApplicationHandlerContext) => Promise<ApplicationWebSocketSessionHandler | void> | ApplicationWebSocketSessionHandler | void;
};
//# sourceMappingURL=application-websockets.d.ts.map