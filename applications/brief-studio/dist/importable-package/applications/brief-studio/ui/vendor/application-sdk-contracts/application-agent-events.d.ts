import type { ApplicationAgentTargetAddress, ApplicationExecutionProducer } from "./application-agent-bindings.js";
export type ApplicationAgentEventSafeErrorCode = "RUNTIME_ERROR" | "TOOL_EXECUTION_ERROR" | "COMPACTION_ERROR" | "SEGMENT_ERROR" | "UNKNOWN_ERROR";
export type ApplicationAgentEventSafeError = {
    code: ApplicationAgentEventSafeErrorCode;
    message: string;
};
export type ApplicationAgentEventSegmentKind = "TEXT" | "REASONING" | "TOOL_CALL" | "COMMAND" | "FILE_EDIT" | "MEDIA" | "OTHER";
export type ApplicationAgentEventStatus = "OFFLINE" | "INITIALIZING" | "IDLE" | "RUNNING" | "ERROR";
...
export type ApplicationAgentRunPublicDataByType = {
    ...
    TOOL_APPROVAL_REQUESTED: ApplicationAgentEventToolRef & {
        argumentSummary: string | null;
    };
    TOOL_APPROVED: ApplicationAgentEventToolRef & {
        reason: string | null;
    };
    ...
    TOOL_EXECUTION_STARTED: ApplicationAgentEventToolRef & {
        argumentSummary: string | null;
    };
    TOOL_EXECUTION_SUCCEEDED: ApplicationAgentEventToolRef & {
        resultSummary: string | null;
    };
    TOOL_EXECUTION_FAILED: ApplicationAgentEventToolRef & {
        error: ApplicationAgentEventSafeError;
    };
    TOOL_EXECUTION_INTERRUPTED: ApplicationAgentEventToolRef & {
        reason: string;
    };
    TOOL_LOG: ApplicationAgentEventToolRef & {
        entry: string;
    };
    TODO_LIST_UPDATE: {
        items: ApplicationAgentEventTodoItem[];
    };
    INTER_AGENT_MESSAGE: {
...
//# sourceMappingURL=application-agent-events.d.ts.map