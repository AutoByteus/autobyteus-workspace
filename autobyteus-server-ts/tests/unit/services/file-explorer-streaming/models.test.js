...
import { ServerMessageType, createConnectedMessage, createFileChangeMessage, createErrorMessage, createPongMessage, } from "../../../../src/services/file-explorer-streaming/models.js";
describe("File explorer streaming models", () => {
    ...
    it("serializes messages with type and payload", () => {
        ...
        const parsed = JSON.parse(message.toJson());
