...
describe("http-access-log-policy", () => {
  it("marks health and graphql routes as noisy", () => {
    expect(__testOnly.isNoisyHttpAccessRoute("GET", "/rest/health")).toBe(true);
    expect(__testOnly.isNoisyHttpAccessRoute("POST", "/graphql")).toBe(true);
  ...
  it("emits warn and error levels for 4xx and 5xx", () => {
