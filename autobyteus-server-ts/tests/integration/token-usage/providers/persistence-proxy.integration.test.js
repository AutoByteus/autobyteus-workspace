...
describe("TokenUsage PersistenceProxy", () => {
    ...
    it("throws for unsupported provider", () => {
        ...
        const proxy = new PersistenceProxy();
        expect(() => proxy.provider).toThrow(/Unsupported token usage provider/i);
    });
    ...
    it("delegates createConversationTokenUsageRecords", async () => {
        ...
        const [promptRecord, completionRecord] = await proxy.createConversationTokenUsageRecords("agent", tokenUsage, "model");
