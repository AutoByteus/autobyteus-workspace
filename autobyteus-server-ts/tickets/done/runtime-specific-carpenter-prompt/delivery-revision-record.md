...
- Next recipient/action: `delivery_engineer` completes safe cleanup of the dedicated ticket worktree and ticket branches, then verifies the final target state.
