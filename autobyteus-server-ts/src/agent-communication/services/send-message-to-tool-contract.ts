...
export const SEND_MESSAGE_TO_TOOL_DESCRIPTION =
  "Send a self-contained message using exactly one selector: recipient_name for a rooted /... or immediate-Team-relative ./... logical Agent-or-Team address, or target_agent_run_id for an exact currently active AgentRun id. Team addresses deliver through the configured coordinator ingress.";

export const SEND_MESSAGE_TO_FIELD_DESCRIPTIONS = {
  recipientName: "Rooted logical Agent-or-Team address using /... or immediate-Team-relative ./... syntax. Bare names are invalid. Provide either recipient_name or target_agent_run_id, never both.",
