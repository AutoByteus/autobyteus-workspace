...
class SqlChannelIngressIdempotencyRepository extends BaseRepository.forModel(
  Prisma.ModelName.ChannelIngressIdempotencyKey,
) {}

export class SqlChannelIdempotencyProvider implements ChannelIdempotencyProvider {
  private readonly repository = new SqlChannelIngressIdempotencyRepository();
