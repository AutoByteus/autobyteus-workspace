import { asString, type ClaudeRuntimeEvent, type ClaudeRunSessionState } from "./claude-runtime-shared.js";
...
export class ClaudeRuntimeToolingCoordinator {
  constructor(
    ...
    >,
    private readonly emitEvent: (state: ClaudeRunSessionState, event: ClaudeRuntimeEvent) => void,
  ) {}
  ...
  processToolLifecycleChunk(state: ClaudeRunSessionState, chunk: unknown): void {
    const payload =
