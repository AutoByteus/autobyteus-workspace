export enum CodexThreadEventName {
  ...
  TURN_DIFF_UPDATED = "turn/diffUpdated",
  ...
  ITEM_FILE_CHANGE_STARTED = "item/fileChange/started",
  ITEM_FILE_CHANGE_DELTA = "item/fileChange/delta",
  ITEM_FILE_CHANGE_COMPLETED = "item/fileChange/completed",
