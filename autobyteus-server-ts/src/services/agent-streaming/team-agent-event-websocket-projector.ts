...
export const projectTeamAgentEventMessage = (
  ...
  switch (event.eventType) {
    ...
    case "TOOL_EXECUTION_COMPLETED": return parseTeamStreamServerMessage({ type: event.eventType, payload: { ...base, invocation_id: event.details.invocationId, tool_name: event.details.toolName, turn_id: event.details.turnId, arguments: event.details.arguments, result: event.details.result } });
