...
- `modules/`: per-module design docs, including `modules/mcp_gateway.md` for the general external MCP gateway and `modules/self_evolution.md` for the manual skill self-evolution capability.
