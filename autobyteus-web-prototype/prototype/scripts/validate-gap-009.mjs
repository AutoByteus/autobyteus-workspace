...
const summary = {
  inventoryId: 'JRN-050', gapId: 'PP-GAP-009', sourcePin,
...
await writeFile(resolve(outputRoot, 'gap-009-results.json'), `${JSON.stringify({ generatedAt: new Date().toISOString(), sourceBaseUrl, prototypeBaseUrl, mockBaseUrl, sourcePin, checkpoints: results }, null, 2)}\n`)
await writeFile(resolve(outputRoot, 'gap-009-summary.json'), `${JSON.stringify(summary, null, 2)}\n`)
