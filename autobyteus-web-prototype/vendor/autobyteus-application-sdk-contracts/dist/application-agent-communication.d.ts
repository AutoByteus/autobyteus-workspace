...
export declare const APPLICATION_AGENT_COMMUNICATION_PROTOCOL: "autobyteus.application-agent-communication.v1";
export type ApplicationAgentConnectionErrorCode = "APPLICATION_NOT_AVAILABLE" | "TARGET_NOT_AVAILABLE" | "INVALID_TARGET" | "RUNTIME_NOT_ACTIVE" | "CONNECTION_ABORTED" | "PROTOCOL_ERROR" | "INPUT_REJECTED" | "EVENT_MAPPING_FAILED" | "EVENT_SERIALIZATION_FAILED" | "BACKPRESSURE_LIMIT" | "TRANSPORT_FAILED";
...
export type ApplicationAgentConnectionCloseReason = "CLIENT_CLOSED" | "ABORTED" | "ESTABLISHMENT_FAILED" | "BINDING_ENDED" | "STREAM_FAILED" | "BACKPRESSURE_LIMIT" | "PROTOCOL_ERROR" | "TRANSPORT_FAILED";
...
export type ApplicationAgentEventStreamSubscribeErrorCode = "SUBSCRIPTION_NOT_AVAILABLE" | "INVALID_STREAM_TARGET" | "RUNTIME_NOT_ACTIVE" | "SUBSCRIPTION_ABORTED" | "WORKER_TRANSPORT_FAILED";
export declare class ApplicationAgentEventStreamSubscribeError extends Error {
    ...
    readonly recoverable: boolean;
    constructor(input: {
        code: ApplicationAgentEventStreamSubscribeErrorCode;
        message: string;
        recoverable: boolean;
    });
}
...
export type ApplicationAgentEventStreamOptions = {
    signal?: AbortSignal;
};
...
//# sourceMappingURL=application-agent-communication.d.ts.map