export declare const APPLICATION_MANIFEST_VERSION_V2: "2";
export declare const APPLICATION_BACKEND_BUNDLE_CONTRACT_VERSION_V1: "1";
export declare const APPLICATION_BACKEND_DEFINITION_CONTRACT_VERSION_V1: "1";
export declare const APPLICATION_FRONTEND_SDK_CONTRACT_VERSION_V1: "1";
...
export type NormalizedPublicationEventFamily = "SESSION_STARTED" | "SESSION_TERMINATED" | "ARTIFACT";
...
export type ApplicationEventHandler = (event: ApplicationEventDispatchEnvelope, context: ApplicationHandlerContext) => Promise<void> | void;
export type ApplicationEventHandlerKey = "sessionStarted" | "sessionTerminated" | "artifact";
