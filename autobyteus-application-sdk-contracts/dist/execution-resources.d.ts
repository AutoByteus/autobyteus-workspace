...
export type ApplicationLaunchOverride = ApplicationAgentLaunchOverride | ApplicationTeamLaunchOverride;
...
export type ApplicationResolvedResourceLaunchBaseline = (ApplicationResolvedResourceLaunchBaselineFields & {
    resourceKind: "AGENT";
...
export type ApplicationEffectiveLaunchConfiguration = (ApplicationEffectiveLaunchConfigurationFields & {
    resourceKind: "AGENT";
}) | (ApplicationEffectiveLaunchConfigurationFields & {
    resourceKind: "AGENT_TEAM";
    teamScopes: ApplicationEffectiveTeamLaunchProfile[];
});
export type ApplicationLaunchIssueScope = "PACKAGE" | "HOST_OVERRIDE" | "HOST_CAPABILITY";
export type ApplicationLaunchIssueCode = "PACKAGE_DEFAULT_MISSING" | "PACKAGE_RESOURCE_UNAVAILABLE" | "PACKAGE_RESOURCE_NOT_ALLOWED" | "PACKAGE_DEFAULT_INCOMPLETE" | "PACKAGE_TEAM_TOPOLOGY_INVALID" | "PACKAGE_FORBIDDEN_HOST_FIELD" | "SAVED_RESOURCE_UNAVAILABLE" | "SAVED_RESOURCE_NOT_ALLOWED" | "SAVED_OVERRIDE_MALFORMED" | "SAVED_MEMBER_TOPOLOGY_STALE" | "RUNTIME_UNAVAILABLE" | "MODEL_UNAVAILABLE" | "CURRENT_MODEL_SELECTION_REQUIRED" | "RUNTIME_AUTHENTICATION_UNAVAILABLE";
...
export {};
//# sourceMappingURL=execution-resources.d.ts.map