...
export const STANDALONE_APPLICATION_BOOTSTRAP_CONTRACT_VERSION = "1" as const;
export const STANDALONE_APPLICATION_PLATFORM_PATH_PREFIX = "/_autobyteus/" as const;
...
export const isConfinedStandalonePlatformPath = (value: unknown): value is string => {
...
const isNullablePlatformPath = (value: unknown): value is string | null =>
  value === null || isConfinedStandalonePlatformPath(value);

export const isStandaloneApplicationBootstrapPayload = (
  value: unknown,
): value is StandaloneApplicationBootstrapPayload => {
...
export const validateStandaloneApplicationBootstrapPayload = (
  value: unknown,
): StandaloneApplicationBootstrapPayload => {
