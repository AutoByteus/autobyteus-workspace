import type { ApplicationStartupState } from "./application-startup-types.js";

type StartupScreenCopy = {
  eyebrow: string;
  title: string;
  description: string;
  detail: string | null;
...
const readCopy = (
  ...
  const copyByState: Partial<Record<ApplicationStartupState, StartupScreenCopy>> = {
    resolving_provider: {
      eyebrow: "AutoByteus application",
