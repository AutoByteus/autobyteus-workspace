...
export type ApplicationStartupState = "resolving_provider" | "acquiring_bootstrap" | "starting_application" | "handoff_complete" | "startup_failed" | "disposed";
export type ApplicationStartupHandle = {
    dispose: () => void;
    getState: () => ApplicationStartupState;
};
//# sourceMappingURL=application-startup-types.d.ts.map