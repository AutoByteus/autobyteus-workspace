...
> = {
  ...
  [StreamEventType.TURN_INTERRUPTED]: TurnLifecycleData,
  [StreamEventType.AGENT_STATUS]: AgentStatusData,
  [StreamEventType.ERROR_EVENT]: ErrorEventData,
  [StreamEventType.COMPACTION_STATUS]: CompactionStatusData,
  ...
  [StreamEventType.TOOL_EXECUTION_INTERRUPTED]: ToolExecutionInterruptedData,
