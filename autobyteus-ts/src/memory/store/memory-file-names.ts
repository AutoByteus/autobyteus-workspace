export const RAW_TRACES_ACTIVE_MEMORY_FILE_NAME = 'raw_traces_active.jsonl';
...
export const COMPACTION_LINEAGE_FILE_NAME = 'compaction_lineage.jsonl';

export const MEMORY_FILE_NAMES = {
  rawTracesActive: RAW_TRACES_ACTIVE_MEMORY_FILE_NAME,
  ...
  compactionLineage: COMPACTION_LINEAGE_FILE_NAME,
} as const;
