...
type VideoClientConstructor = new (model: VideoModel, config: MultimediaConfig) => BaseVideoClient;
...
export class VideoModel {
  ...
  createClient(configOverride?: MultimediaConfig | null): BaseVideoClient {
