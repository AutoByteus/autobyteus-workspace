...
/** Legacy OpenAI Responses renderer for explicit text-parser tool-call modes only. */
export class OpenAIResponsesTextToolHistoryRenderer extends OpenAIResponsesRenderer {
