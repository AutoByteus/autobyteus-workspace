import { OllamaPromptRenderer, type OllamaRenderedMessage } from './ollama-prompt-renderer.js';
import {
  Message,
  MessageRole,
  ToolCallPayload,
...
/** Legacy Ollama renderer for explicit text-parser tool-call modes only. */
export class OllamaTextToolHistoryRenderer extends OllamaPromptRenderer {
