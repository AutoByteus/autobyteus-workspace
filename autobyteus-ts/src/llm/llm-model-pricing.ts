...
export type ModelPricingTierInfo = {
  ...
  trusted_dimensions: PricingTrustDimensions;
};
...
export type ModelPricingInfo = {
  ...
  trusted_dimensions: PricingTrustDimensions;
  missing_reason?: 'model_not_found' | 'pricing_config_absent' | 'constructor_default_zero' | 'placeholder_price' | 'dimension_missing';
};
