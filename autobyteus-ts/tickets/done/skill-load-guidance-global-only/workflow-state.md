...
- Ticket Worktree Path: `/Users/normy/autobyteus_org/worktrees/skill-load-guidance-global-only`
- Ticket Branch: `codex/skill-load-guidance-global-only`
...
| --- | --- | --- | --- |
| 0 Bootstrap + Draft Requirement | Pass | Ticket bootstrap complete + if git repo: base branch resolved, remote freshness handled for new bootstrap, dedicated ticket worktree/branch created or reused + `requirements.md` Draft captured | `requirements.md`, `workflow-state.md`, worktree at `/Users/normy/autobyteus_org/worktrees/skill-load-guidance-global-only` |
...
| T-002 | 2026-04-08 | 1 | 2 | Investigation complete, refining requirements for mode-scoped prompt guidance | N/A | Locked | `investigation-notes.md`, `requirements.md`, `workflow-state.md` |
| T-003 | 2026-04-08 | 2 | 3 | Requirements are design-ready, moving to small-scope solution sketch | N/A | Locked | `requirements.md`, `workflow-state.md` |
| T-004 | 2026-04-08 | 3 | 4 | Solution sketch complete, capturing future-state prompt flow | N/A | Locked | `implementation.md`, `workflow-state.md` |
| T-005 | 2026-04-08 | 4 | 5 | Future-state runtime call stack is current, starting review rounds | N/A | Locked | `future-state-runtime-call-stack.md`, `workflow-state.md` |
| T-006 | 2026-04-08 | 5 | 6 | Stage 5 review reached Go Confirmed, unlocking implementation | N/A | Unlocked | `future-state-runtime-call-stack-review.md`, `workflow-state.md`, `implementation.md` |
| T-007 | 2026-04-08 | 6 | 7 | Implementation completed, moving to executable validation evidence | N/A | Unlocked | `implementation.md`, `workflow-state.md` |
| T-008 | 2026-04-08 | 7 | 8 | Executable validation passed, moving to code review | N/A | Locked | `api-e2e-testing.md`, `workflow-state.md` |
