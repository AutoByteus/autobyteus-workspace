...
| LLM | `DeepSeek V4 Pro (Qwen)` | `deepseek-v4-pro` | Qwen / Alibaba | 2026-08-06 | Alibaba-served exact value with identifier `qwen:deepseek-v4-pro` and 1M context metadata; no alias or producer field. |
| LLM | `GLM-5.2 (Qwen)` | `glm-5.2` | Qwen / Alibaba | 2026-08-06 | Alibaba-served exact value with identifier `qwen:glm-5.2` and conservative 198k context metadata; no alias or producer field. |
