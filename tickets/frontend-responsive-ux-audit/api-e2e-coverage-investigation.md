...
- Trigger: Proportional durable-test review recorded finding TR-001 against the FR-033 helper: it did not prove a measurable drag effect or capacity-derived width stop. This is a test-only Local Fix on the same approved implementation HEAD `648dad8a3e6312fd6352fd7dc7600fd4c27fbb1d`; API/E2E must add deterministic width assertions, rerun current checks and the full browser matrix, then return for proportional review.
...
- Latest Authoritative Investigation: `Round 12`
