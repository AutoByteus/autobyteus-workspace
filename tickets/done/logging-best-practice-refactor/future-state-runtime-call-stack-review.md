...
- Runtime Call Stack Document: `tickets/in-progress/logging-best-practice-refactor/future-state-runtime-call-stack.md`
- Source Design Basis:
  - `Medium/Large`: `tickets/in-progress/logging-best-practice-refactor/proposed-design.md`
...
- Shared-principles rule: the review keeps the logging ownership boundary in the centralized logger factories and keeps sinks/bootstrap off the main application logging line.
- Existing-capability rule: the design extends the existing logging subsystems instead of adding a new ad hoc cross-runtime wrapper.
- Spine inventory rule: `DS-001`, `DS-002`, `DS-003`, and `DS-004` cover all in-scope top-level and bounded-local behaviors.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| UC-001 | `DS-001` | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | N/A | Pass | Pass | Pass | Pass | Pass | Pass | N/A | Pass | Pass | `None` | Pass | Pass | Pass | Pass | Pass |
| UC-002 | `DS-001`, `DS-004` | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | N/A | Pass | Pass | Pass | Pass | Pass | Pass | N/A | Pass | Pass | `None` | Pass | Pass | Pass | Pass | Pass |
| UC-003 | `DS-002` | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | N/A | Pass | Pass | Pass | Pass | Pass | Pass | N/A | Pass | Pass | `None` | Pass | Pass | Pass | Pass | Pass |
| UC-004 | `DS-003` | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | N/A | Pass | Pass | Pass | Pass | Pass | Pass | N/A | Pass | Pass | `None` | Pass | Pass | Pass | Pass | Pass |
| UC-005 | `DS-001`, `DS-002`, `DS-004` | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | N/A | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | Pass | `Legacy console threshold boundary is explicit and bounded` | Pass | Pass | Pass | Pass | Pass |
