...
All retained raw logs are under `/Users/normy/autobyteus_org/autobyteus-workspace-superrepo/tickets/done/codex-luna-agent-run-prepare-failure/evidence/api-e2e/`. Failed intermediate runs are intentionally retained with the passing reruns.
