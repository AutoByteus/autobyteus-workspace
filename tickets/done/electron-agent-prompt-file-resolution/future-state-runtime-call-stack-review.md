...
- Runtime Call Stack Document: `tickets/in-progress/electron-agent-prompt-file-resolution/future-state-runtime-call-stack.md`
- Source Design Basis: `tickets/in-progress/electron-agent-prompt-file-resolution/implementation-plan.md`
...
| --- | --- | --- | --- | --- | --- | --- |
| 1 | runtime-consistency / next-run freshness / fallback behavior | None | N/A | N/A | N/A | No |
| 2 | runtime-consistency / next-run freshness / fallback behavior | None | N/A | N/A | N/A | No |
...
- Remove/Decommission Checks Complete For Scoped `Remove`/`Rename/Move`: `Yes` (runtime prompt reread path can be removed without introducing compatibility shims)
