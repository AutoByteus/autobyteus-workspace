...
const evidenceRoot = path.join(
  workspaceRoot,
  'tickets/in-progress/agent-team-codex-output-not-visible/api-e2e-evidence/api-rev-002/environment',
);
...
const runtimeRoot = path.join(
  workspaceRoot,
  'autobyteus-server-ts/tests/.tmp/api-rev-002-live-20260817-1',
);
const databasePath = path.join(
  workspaceRoot,
  'autobyteus-server-ts/db/api-rev-002-live-20260817-1.db',
);
