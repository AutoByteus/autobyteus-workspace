...
const summaryPath = path.join(artifactDir, 'api-e2e-round12-embedded-server-high-churn-20260529.json');
const serverStdoutPath = path.join(artifactDir, 'api-e2e-round12-embedded-server-high-churn-20260529-server.stdout.log');
const serverStderrPath = path.join(artifactDir, 'api-e2e-round12-embedded-server-high-churn-20260529-server.stderr.log');
