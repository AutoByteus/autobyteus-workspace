...
const summaryPath = path.join(artifactDir, 'api-e2e-round5-embedded-server-high-churn.json');
const serverStdoutPath = path.join(artifactDir, 'api-e2e-round5-embedded-server-high-churn-server.stdout.log');
const serverStderrPath = path.join(artifactDir, 'api-e2e-round5-embedded-server-high-churn-server.stderr.log');
