...
const summaryPath = path.join(artifactDir, 'api-e2e-round6-embedded-server-high-churn-20260523.json');
const serverStdoutPath = path.join(artifactDir, 'api-e2e-round6-embedded-server-high-churn-20260523-server.stdout.log');
const serverStderrPath = path.join(artifactDir, 'api-e2e-round6-embedded-server-high-churn-20260523-server.stderr.log');
