...
const summaryPath = path.join(artifactDir, 'code-review-round12-terminal-fd-probe-20260523.json');
const logPath = path.join(artifactDir, 'code-review-round12-terminal-fd-probe-20260523-server.log');
const lsofPath = path.join(artifactDir, 'code-review-round12-terminal-fd-probe-20260523-final-lsof.log');
