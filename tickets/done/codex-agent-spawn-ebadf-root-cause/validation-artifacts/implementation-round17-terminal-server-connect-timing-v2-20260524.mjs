...
const summaryPath = path.join(artifactDir, 'implementation-round17-terminal-server-connect-timing-v2-20260524.json');
const eventLogPath = path.join(artifactDir, 'implementation-round17-terminal-server-connect-timing-v2-20260524.log');
const serverLogPath = path.join(artifactDir, 'implementation-round17-terminal-server-connect-timing-v2-20260524-server.log');
const finalLsofPath = path.join(artifactDir, 'implementation-round17-terminal-server-connect-timing-v2-20260524-final-lsof.log');
