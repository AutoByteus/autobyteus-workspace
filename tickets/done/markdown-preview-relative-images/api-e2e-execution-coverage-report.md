...
| --- | --- | --- | --- |
| `tickets/done/markdown-preview-relative-images/evidence/chromium-results.json` | semantic DOM/network/lifecycle result | Retained | authoritative browser result |
