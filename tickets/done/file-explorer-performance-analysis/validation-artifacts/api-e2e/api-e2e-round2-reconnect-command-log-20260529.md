# API/E2E round 2 reconnect-resync command log
UTC 2026-05-29T15:48:33Z
## git diff --check
## Frontend reconnect/workspace durable suites
...
[FileExplorerStreaming] Connecting to ws://localhost:8000/ws/file-explorer/ws-1...
 ...
 ✓ services/fileExplorerStreaming/__tests__/FileExplorerStreamingService.spec.ts (18 tests) 11ms
...
[Workspace] Connected to file system changes: reconnected-session
 ...
 ✓ stores/__tests__/workspaceStore.reconnect-resync.spec.ts (2 tests) 7ms
...
[Workspace] Disconnected from file system watcher for workspace: ws-1
 ...
 ✓ stores/__tests__/workspaceStore.spec.ts (12 tests) 28ms

 Test Files  3 passed (3)
      Tests  32 passed (32)
   Start at  17:48:35
   Duration  4.64s (transform 2.48s, setup 12.03s, collect 133ms, tests 46ms, environment 481ms, prepare 485ms)

## Frontend boundary guard
