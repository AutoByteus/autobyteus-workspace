...
## Document status
Approved SR-004 revised baseline — approval SR-005, 2026-09-17. User replied ‘confirm’ to the explicit two-part revised-scope request (source-configuration-seeded new Org draft and accurate missing-model hint). Prior SR-001/SR-002 authority remains for unchanged Settings requirements. This approval does not retroactively extend the narrower earlier Plus contract. IR-001 and its successful validation evidence are preserved; dependent correction awaits revised design and review.
