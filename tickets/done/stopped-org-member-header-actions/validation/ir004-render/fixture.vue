...
canonical.root_team.members[0].launch_configuration.llm_model_identifier='replacement-model'
...
Object.defineProperty(llm,'providersWithModelsForSelection',{value:()=>[{provider:{id:'OPENAI',name:'Synthetic',providerType:'OPENAI',isCustom:false},models:['model','replacement-model'].map(model=>({modelIdentifier:model,name:model,value:model,canonicalName:model,providerId:'OPENAI',providerName:'Synthetic',providerType:'OPENAI',runtime:'api',configSchema:{type:'object',properties:{budget:{type:'integer',minimum:0}}}}))}]})
