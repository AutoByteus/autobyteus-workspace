...
DB=Path('.autobyteus/api-e2e-005/applications/bundle-app__brief-studio__308117954720f6e58a3b1422c1b93a2dadc96910ab03e466aad2a63f78ff5bd8/db/app.sqlite')
OUT=Path('tickets/in-progress/application-owned-mcp-capability/api-e2e-evidence/api-rev-005/db-state-transitions.jsonl')
BRIEF='brief-ed4d6b1f-46a8-4d32-b4d3-4491ea068433'
...
Path('tickets/in-progress/application-owned-mcp-capability/api-e2e-evidence/api-rev-005/before-launch-db.json').write_text(json.dumps(initial,indent=2))
