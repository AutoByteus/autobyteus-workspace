...
- Recovery cleanup: local main `personal` was fast-forwarded to the final audit without altering unrelated dirty work; the recovery worktree/local branch were removed; no remote recovery branch existed.
