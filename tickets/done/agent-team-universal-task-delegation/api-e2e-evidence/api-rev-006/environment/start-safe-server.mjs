...
const runtimeRoot = path.join(
  workspaceRoot,
  'autobyteus-server-ts/tests/.tmp/api-rev-006-live-20260815-1',
);
const databasePath = path.join(
  workspaceRoot,
  'autobyteus-server-ts/db/api-rev-006-live-20260815-1.db',
);
...
process.stdout.write(`API_REV_006_SAFE_SERVER_READY ${JSON.stringify(marker)}\n`);
