...
const base=process.env.GRAPHQL_URL??'http://127.0.0.1:60311/graphql';
const providerDir=new URL('../provider/',import.meta.url);
const ids=[
  JSON.parse(await readFile(new URL('fixture-codex-api-f006-recheck-create.json',providerDir))).teamRunId,
