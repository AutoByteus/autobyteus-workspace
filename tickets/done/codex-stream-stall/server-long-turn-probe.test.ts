...
import { CodexThreadManager } from "../../../autobyteus-server-ts/src/agent-execution/backends/codex/thread/codex-thread-manager.js";
import {
  CodexApprovalPolicy,
  type CodexSandboxMode,
} from "../../../autobyteus-server-ts/src/agent-execution/backends/codex/thread/codex-thread-config.js";
import { CodexAppServerClient } from "../../../autobyteus-server-ts/src/runtime-management/codex/client/codex-app-server-client.js";
import { CodexAppServerClientManager } from "../../../autobyteus-server-ts/src/runtime-management/codex/client/codex-app-server-client-manager.js";
...
import { CodexModelCatalog } from "../../../autobyteus-server-ts/src/llm-management/services/codex-model-catalog.js";

const codexBinaryReady = spawnSync("codex", ["--version"], {
  stdio: "ignore",
}).status === 0;
const describeLiveProbe = codexBinaryReady ? describe : describe.skip;
...
describeLiveProbe("Server-side Codex long-turn cadence probe", () => {
