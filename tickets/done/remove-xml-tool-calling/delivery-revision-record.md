...
- Triggering upstream report, verification, or evidence: `/Users/normy/autobyteus_org/autobyteus-worktrees/remove-xml-tool-calling/tickets/done/remove-xml-tool-calling/api-e2e-test-review-report.md`, with the cumulative package from `requirements.md` through `api-e2e-execution-coverage-report.md` and `code-review-revision-record.md`.
...
- Docs sync report: `/Users/normy/autobyteus_org/autobyteus-worktrees/remove-xml-tool-calling/tickets/done/remove-xml-tool-calling/docs-sync-report.md`
- Handoff summary: `/Users/normy/autobyteus_org/autobyteus-worktrees/remove-xml-tool-calling/tickets/done/remove-xml-tool-calling/handoff-summary.md`
- Release/publication/deployment report: `/Users/normy/autobyteus_org/autobyteus-worktrees/remove-xml-tool-calling/tickets/done/remove-xml-tool-calling/release-deployment-report.md`
- Release notes: `/Users/normy/autobyteus_org/autobyteus-worktrees/remove-xml-tool-calling/tickets/done/remove-xml-tool-calling/release-notes.md`
...
- Build/verification evidence: `/Users/normy/autobyteus_org/autobyteus-worktrees/remove-xml-tool-calling/tickets/done/remove-xml-tool-calling/electron-build-macos-arm64-delivery.log`.
