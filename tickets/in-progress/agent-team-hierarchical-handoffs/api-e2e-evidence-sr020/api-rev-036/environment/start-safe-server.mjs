...
const runtimeRoot = path.join(
  workspaceRoot,
  'autobyteus-server-ts/tests/.tmp/api-rev-036-live-20260813-1',
);
const databasePath = path.join(
  workspaceRoot,
  'autobyteus-server-ts/db/api-rev-036-live-20260813-1.db',
);
...
process.stdout.write(`API_REV_036_SAFE_SERVER_READY ${JSON.stringify(marker)}\n`);
