...
const runtimeRoot = path.join(testRuntimeRoot, 'api-rev-037-live-20260813-1');
const databasePath = path.join(serverRoot, 'db', 'api-rev-037-live-20260813-1.db');
...
const materialized = materializeTestRuntime({
  ...
  serverUrlOverride: 'http://127.0.0.1:60237',
});
