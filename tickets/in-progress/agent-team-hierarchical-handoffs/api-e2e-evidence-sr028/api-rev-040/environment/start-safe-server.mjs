...
const runtimeRoot = path.join(
  workspaceRoot,
  'autobyteus-server-ts/tests/.tmp/api-rev-040-live-20260813-1',
);
const databasePath = path.join(
  workspaceRoot,
  'autobyteus-server-ts/db/api-rev-040-live-20260813-1.db',
);
...
process.stdout.write(`API_REV_040_SAFE_SERVER_READY ${JSON.stringify(marker)}\n`);
