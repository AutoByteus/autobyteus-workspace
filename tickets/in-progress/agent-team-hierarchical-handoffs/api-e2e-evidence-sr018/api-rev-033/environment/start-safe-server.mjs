...
const runtimeRoot = path.join(
  workspaceRoot,
  'autobyteus-server-ts/tests/.tmp/api-rev-033-live-20260812-1',
);
const databasePath = path.join(
  workspaceRoot,
  'autobyteus-server-ts/db/api-rev-033-live-20260812-1.db',
);
...
process.stdout.write(`API_REV_033_SAFE_SERVER_READY ${JSON.stringify(marker)}\n`);
