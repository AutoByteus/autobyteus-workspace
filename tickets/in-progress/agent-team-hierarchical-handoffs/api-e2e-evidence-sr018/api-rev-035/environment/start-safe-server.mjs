...
const runtimeRoot = path.join(
  workspaceRoot,
  'autobyteus-server-ts/tests/.tmp/api-rev-035-live-20260812-1',
);
const databasePath = path.join(
  workspaceRoot,
  'autobyteus-server-ts/db/api-rev-035-live-20260812-1.db',
);
...
process.stdout.write(`API_REV_035_SAFE_SERVER_READY ${JSON.stringify(marker)}\n`);
