...
const runtimeRoot = path.join(testRuntimeRoot, 'api-rev-034-live-20260812-1');
const databasePath = path.join(serverRoot, 'db', 'api-rev-034-live-20260812-1.db');
...
const materialized = materializeTestRuntime({
  ...
  serverUrlOverride: 'http://127.0.0.1:60234',
});
