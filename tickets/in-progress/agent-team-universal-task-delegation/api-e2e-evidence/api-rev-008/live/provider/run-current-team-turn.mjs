...
const teamWsUrl = process.env.TEAM_WS_URL ?? 'ws://127.0.0.1:60313/ws/agent-team';
    ...
    if (message.type === 'TEAM_EXECUTION_VIEW_SNAPSHOT' && !sent) {
      ...
      ws.send(JSON.stringify({
        ...
        payload: {
          ...
          message_id: `api-rev-008-${crypto.randomUUID()}`,
          dedupe_key: `api-rev-008-${crypto.randomUUID()}`,
        },
      }));
    }
