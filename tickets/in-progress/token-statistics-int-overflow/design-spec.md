...
| --- | --- | --- | --- | --- |
| `/Users/normy/autobyteus_org/autobyteus-worktrees/token-statistics-int-overflow/tickets/in-progress/token-statistics-int-overflow/graphql-token-count-contract.md` | Exact token scalar, field-family scope, codegen mapping, invariants, rejected alternatives, and coverage shape. | REQ-001, REQ-002; AC-001, AC-002, AC-005 | Supplies the protocol-level details projected into the file/interface design below. | Current; approved with requirements basis on 2026-07-28. |
