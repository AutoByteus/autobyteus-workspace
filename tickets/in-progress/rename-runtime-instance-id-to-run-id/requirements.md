...
- Design-ready confirmation date: `2026-02-25`
...
- Enterprise implementation will be executed from scratch on this worktree branch, using personal ticket artifacts as reference only.
...
| --- | --- |
| `R-001` | `UC-001`, `UC-003`, `UC-004`, `UC-007` |
| `R-002` | `UC-002`, `UC-003`, `UC-004`, `UC-007` |
| `R-003` | `UC-003`, `UC-006`, `UC-010`, `UC-011` |
| `R-004` | `UC-005`, `UC-006`, `UC-008`, `UC-010` |
| `R-005` | `UC-001`, `UC-002`, `UC-004` |
| `R-006` | `UC-007`, `UC-010`, `UC-011` |
| `R-007` | `UC-006` |
| `R-008` | `UC-009`, `UC-011` |
| `R-009` | `UC-007` |
| `R-010` | `UC-008` |
