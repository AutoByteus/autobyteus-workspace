...
```text
[ENTRY] /Users/normy/autobyteus_org/autobyteus-web/components/workspace/running/RunningAgentsPanel.vue:selectAgentRun(runId)
├── /Users/normy/autobyteus_org/autobyteus-web/stores/agentSelectionStore.ts:selectRun(runId, 'agent') [STATE]
├── RunningAgentsPanel.vue:$emit('run-selected', { type: 'agent', runId })
...
RunningAgentsPanel.vue:selectTeamRun(runId)
├── agentSelectionStore.ts:selectRun(runId, 'team') [STATE]
...
```text
[ENTRY] /Users/normy/autobyteus_org/autobyteus-web/components/workspace/running/RunningAgentsPanel.vue:selectTeamRun(runId)
├── /Users/normy/autobyteus_org/autobyteus-web/stores/agentSelectionStore.ts:selectRun(runId, 'team') [STATE]
├── emit('run-selected', { type: 'team', runId })
└── /Users/normy/autobyteus_org/autobyteus-web/components/AppLeftPanel.vue:onRunningInstanceSelected()
...
same flow with selectAgentRun(runId)
```
...
```text
[ENTRY] /Users/normy/autobyteus_org/autobyteus-web/components/workspace/running/RunningAgentsPanel.vue:createAgentRun(definitionId)
...
├── /Users/normy/autobyteus_org/autobyteus-web/stores/agentContextsStore.ts:createRunFromTemplate() [STATE]
...
RunningAgentsPanel.vue:createTeamRun(definitionId)
├── teamRunConfigStore.ts:setTemplate(...) [STATE]
└── agentTeamContextsStore.ts:createRunFromTemplate() [STATE]
```

```text
[ERROR] definition not found
RunningAgentsPanel.vue:createAgentRun(definitionId)
