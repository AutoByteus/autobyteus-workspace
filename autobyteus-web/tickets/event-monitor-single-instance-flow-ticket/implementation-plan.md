...
- Use Cases In Scope:
  - Select an existing agent/team run from the left running panel and render only that instance in the center.
...
- Touched Files/Modules:
  ...
  - `/Users/normy/autobyteus_org/autobyteus-web/components/workspace/running/RunningAgentRunRow.vue` (comment cleanup)
- API/Behavior Delta:
