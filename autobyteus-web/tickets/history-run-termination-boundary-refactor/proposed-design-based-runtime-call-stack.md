...
│   ├── stores/agentContextsStore.ts:getRun(runId)
│   ├── [ASYNC][IO] utils/apolloClient.ts:getApolloClient().mutate(TerminateAgentRun)
...
├── [ASYNC][IO] apollo mutate terminateAgentRun
├── stores/agentRunStore.ts:result = data.terminateAgentRun
