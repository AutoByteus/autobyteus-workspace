...
- Notes:
  - Root cause confirmed before coding: several "new run" handlers call `createRunFromTemplate()` directly, which selects a run and suppresses `RunConfigPanel` rendering.
