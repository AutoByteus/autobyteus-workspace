...
const outDir = path.resolve(process.env.AGY_E2E_OUTPUT_DIR || path.join(ticketDir, 'api-e2e-round5-process-restart-browser'));
const evidence = { startedAt: new Date().toISOString(), commit: spawnSync('git',['rev-parse','HEAD'],{cwd:rootDir,encoding:'utf8'}).stdout.trim(), runtime: {}, identities: {}, cases: {}, processes: [], failures: [], cleanup: {} };
