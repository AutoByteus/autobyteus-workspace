export type BrowserDomSnapshotBoundingBox = {
  x: number
  y: number
  width: number
  height: number
...
export type BrowserDomSnapshotElement = {
  element_id: string
  tag_name: string
  dom_id: string | null
  css_selector: string
  ...
  href: string | null
  value: string | null
  bounding_box: BrowserDomSnapshotBoundingBox | null
}

export type BrowserDomSnapshotScriptResult = {
...
export const BROWSER_DOM_SNAPSHOT_SCRIPT = `(({ includeNonInteractive, includeBoundingBoxes, maxElements }) => {
