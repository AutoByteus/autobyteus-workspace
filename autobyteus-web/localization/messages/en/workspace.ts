...
const messages = {
  ...
  "workspace.runModelConfig.savedOrOfferedGroup": "Saved / runtime-offered model",
  "workspace.runModelConfig.selectedGroup": "Selected model",
  ...
  "workspace.runModelConfig.optionsUnavailable": "Runtime model options are unavailable. Retry to load replacements; current-model settings remain available.",
