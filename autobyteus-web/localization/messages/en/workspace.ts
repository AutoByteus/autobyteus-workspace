...
const messages = {
  ...
  "workspace.components.workspace.config.TeamRunConfigForm.scopes_and_agents":
    "Team scopes and Agents ({{count}})",
  "workspace.components.workspace.config.StoredTeamRunConfig.root_defaults": "Stored root Team defaults",
  "workspace.components.workspace.config.StoredTeamRunConfig.stored_members": "Stored Team and Agent configuration",
  "workspace.components.workspace.config.StoredTeamRunConfig.read_only": "This is the exact stored configuration for the selected TeamRun. It is read-only.",
  "workspace.components.workspace.config.StoredTeamRunConfig.runtime": "Runtime",
  "workspace.components.workspace.config.StoredTeamRunConfig.model": "Model",
  "workspace.components.workspace.config.StoredTeamRunConfig.workspace": "Workspace",
  "workspace.components.workspace.config.StoredTeamRunConfig.skill_access": "Skill access",
  "workspace.components.workspace.config.StoredTeamRunConfig.auto_execute": "Auto approve",
  "workspace.components.workspace.config.StoredTeamRunConfig.model_config": "Model config",
  "workspace.components.workspace.config.StoredTeamRunConfig.none": "None",
  "workspace.components.workspace.config.StoredTeamRunConfig.enabled": "Enabled",
  "workspace.components.workspace.config.StoredTeamRunConfig.disabled": "Disabled",
  "workspace.components.workspace.config.StoredTeamRunConfig.customized": "Customized",
  "workspace.components.workspace.config.StoredTeamRunConfig.inherited": "Matches parent",
  ...
  "workspace.components.workspace.config.TeamScopeConfigEditor.reset_aria": "Reset settings for {{address}}",
  "workspace.components.workspace.config.TeamScopeConfigEditor.root_defaults": "Root Team defaults",
  "workspace.components.workspace.config.TeamScopeConfigEditor.effective": "Effective",
  "workspace.components.workspace.config.TeamScopeConfigEditor.customized_fields": "Customized fields:",
  "workspace.components.workspace.config.TeamScopeConfigEditor.no_model": "No model",
  "workspace.components.workspace.config.TeamScopeConfigEditor.runtime_help": "Runtime used by this Team scope.",
  "workspace.components.workspace.config.TeamScopeConfigEditor.team_default_model": "Team default model",
