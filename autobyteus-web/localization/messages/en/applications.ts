...
const applicationMessages = {
  ...
  'applications.components.applications.ApplicationLaunchConfigModal.handshakeNote': 'The bundled iframe UI will not bootstrap until the exact iframe contract v4 ready/bootstrap handshake succeeds.',
  ...
  'applications.components.applications.ApplicationLaunchSetupPanel.noSlotsDescription': 'This application does not currently expose any manifest-declared execution resource slots for host-managed setup.',
  ...
  'applications.components.applications.ApplicationLaunchSetupPanel.resourceLabel': 'Execution resource',
  ...
  'applications.components.applications.ApplicationLaunchSetupPanel.mixedInheritedRuntime': 'Mixed / inherited per member',
  ...
  'applications.components.applications.ApplicationLaunchSetupPanel.selectResourceFirst': 'Select a execution resource first to save launch defaults for this slot.',
  ...
  'applications.components.applications.ApplicationLaunchSetupPanel.cancelChanges': 'Cancel draft changes',
  ...
  'applications.components.applications.ApplicationLaunchSetupPanel.packageBaseline': 'Package baseline',
  'applications.components.applications.ApplicationLaunchSetupPanel.selectedResourceBaseline': 'Selected resource baseline',
  'applications.components.applications.ApplicationLaunchSetupPanel.savedOverride': 'Saved host override',
  'applications.components.applications.ApplicationLaunchSetupPanel.noSavedOverride': 'No saved override',
  'applications.components.applications.ApplicationLaunchSetupPanel.effectiveConfiguration': 'Effective configuration',
  ...
  'applications.components.applications.ApplicationLaunchSetupPanel.currentAgentDefinition': 'Current agent',
  'applications.components.applications.ApplicationLaunchSetupPanel.staleMemberAgentChanged': 'The saved route now points to a different agent',
  'applications.components.applications.ApplicationLaunchSetupPanel.staleMemberMissing': 'The saved route is no longer in this team',
  'applications.components.applications.ApplicationExecutionResourceSlotEditor.noEditorForSelection': 'This slot only saves the selected execution resource for the current resource kind.',
  'applications.components.applications.ApplicationWorkspaceRootSelector.loadedWorkspaces': 'Loaded workspaces',
  'applications.components.applications.ApplicationWorkspaceRootSelector.customPath': 'Custom path',
  'applications.components.applications.ApplicationWorkspaceRootSelector.selectWorkspacePlaceholder': 'Choose a loaded workspace path',
  'applications.components.applications.ApplicationWorkspaceRootSelector.searchWorkspacePlaceholder': 'Search loaded workspaces...',
  'applications.components.applications.ApplicationWorkspaceRootSelector.noLoadedWorkspaces': 'No loaded workspaces are available yet.',
  'applications.components.applications.ApplicationWorkspaceRootSelector.loadedWorkspaceHelp': 'Reuse the absolute path from a currently loaded workspace, or switch to a custom path.',
  'applications.components.applications.ApplicationWorkspaceRootSelector.customPathPlaceholder': '/path/to/workspace',
  'applications.components.applications.ApplicationWorkspaceRootSelector.customPathHelp': 'Enter or browse for an absolute workspace root path to reuse during application-owned launches.',
  ...
  'applications.components.applications.ApplicationTeamLaunchProfileEditor.memberOverridesHelp': 'Each member inherits the shared defaults unless you set a runtime or model override here.',
  'applications.components.applications.ApplicationTeamLaunchProfileEditor.staleOverrideLocked': 'This saved team topology is stale. Select a replacement resource or reset to package defaults before editing launch values.',
  'applications.components.applications.ApplicationTeamLaunchProfileEditor.replaceStaleTopology': 'Replace with current team topology',
  'applications.components.applications.ApplicationTeamMemberOverrideItem.overrideActive': 'Override active',
  'applications.components.applications.ApplicationTeamMemberOverrideItem.runtimeOverride': 'Runtime override',
  'applications.components.applications.ApplicationTeamMemberOverrideItem.inheritGlobalRuntime': 'Inherit global runtime',
  'applications.components.applications.ApplicationTeamMemberOverrideItem.modelOverride': 'Model override',
  'applications.components.applications.ApplicationTeamMemberOverrideItem.chooseCompatibleModel': 'Choose a compatible member model',
  'applications.components.applications.ApplicationTeamMemberOverrideItem.inheritGlobalModel': 'Inherit global model',
