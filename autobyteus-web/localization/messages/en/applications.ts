...
const applicationMessages = {
  ...
  'applications.components.applications.ApplicationResourceSlotEditor.noEditorForSelection': 'This slot only saves the selected runtime resource for the current resource kind.',
