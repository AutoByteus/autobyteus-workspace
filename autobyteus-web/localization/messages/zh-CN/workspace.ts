...
const messages = {
  ...
  "workspace.runModelConfig.savedOrOfferedGroup": "已保存／运行时提供的模型",
  "workspace.runModelConfig.selectedGroup": "已选择的模型",
  ...
  "workspace.runModelConfig.optionsUnavailable": "运行时模型选项暂不可用。请重试加载替换模型；仍可编辑当前模型的设置。",
