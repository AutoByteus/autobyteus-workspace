...
const messages = {
  ...
  "workspace.components.workspace.config.TeamRunConfigForm.scopes_and_agents":
    "团队范围和智能体（{{count}}）",
  "workspace.components.workspace.config.StoredTeamRunConfig.root_defaults": "已存储的根团队默认设置",
  "workspace.components.workspace.config.StoredTeamRunConfig.stored_members": "已存储的团队和智能体配置",
  "workspace.components.workspace.config.StoredTeamRunConfig.read_only": "这是所选 TeamRun 的准确存储配置，且为只读。",
  "workspace.components.workspace.config.StoredTeamRunConfig.runtime": "运行时",
  "workspace.components.workspace.config.StoredTeamRunConfig.model": "模型",
  "workspace.components.workspace.config.StoredTeamRunConfig.workspace": "工作区",
  "workspace.components.workspace.config.StoredTeamRunConfig.skill_access": "技能访问",
  "workspace.components.workspace.config.StoredTeamRunConfig.auto_execute": "自动批准",
  "workspace.components.workspace.config.StoredTeamRunConfig.model_config": "模型配置",
  "workspace.components.workspace.config.StoredTeamRunConfig.none": "无",
  "workspace.components.workspace.config.StoredTeamRunConfig.enabled": "已启用",
  "workspace.components.workspace.config.StoredTeamRunConfig.disabled": "已禁用",
  "workspace.components.workspace.config.StoredTeamRunConfig.customized": "已自定义",
  "workspace.components.workspace.config.StoredTeamRunConfig.inherited": "与父级相同",
  ...
  "workspace.components.workspace.config.TeamScopeConfigEditor.reset_aria": "重置 {{address}} 的设置",
  "workspace.components.workspace.config.TeamScopeConfigEditor.root_defaults": "根团队默认设置",
  "workspace.components.workspace.config.TeamScopeConfigEditor.effective": "生效值",
  "workspace.components.workspace.config.TeamScopeConfigEditor.customized_fields": "已自定义字段：",
  "workspace.components.workspace.config.TeamScopeConfigEditor.no_model": "未选择模型",
  "workspace.components.workspace.config.TeamScopeConfigEditor.runtime_help": "此团队范围使用的运行时。",
  "workspace.components.workspace.config.TeamScopeConfigEditor.team_default_model": "团队默认模型",
