...
const messages = {
  ...
  'workspace.components.workspace.team.TeamOverviewPanel.team': '团队',
  'workspace.components.workspace.team.TeamOverviewPanel.task_plan': '任务计划',
  'workspace.components.workspace.team.TeamCommunicationPanel.title': '团队沟通',
  'workspace.components.workspace.team.TeamCommunicationPanel.sent_messages': '已发送消息',
  'workspace.components.workspace.team.TeamCommunicationPanel.received_messages': '已接收消息',
  'workspace.components.workspace.team.TeamCommunicationPanel.sent_to': '发送给',
  'workspace.components.workspace.team.TeamCommunicationPanel.received_from': '接收自',
  'workspace.components.workspace.team.TeamCommunicationPanel.to': '给',
  'workspace.components.workspace.team.TeamCommunicationPanel.from': '来自',
