...
const mockStreamingConnections: Array<{ connect: ReturnType<typeof vi.fn>; disconnect: ReturnType<typeof vi.fn> }> = [];
...
vi.mock('~/services/fileExplorerStreaming/FileExplorerStreamingService', () => {
    return {
        FileExplorerStreamingService: vi.fn(() => {
            ...
            mockStreamingConnections.push(streamConnection);
...
describe('workspaceStore', () => {
  beforeEach(() => {
    vi.clearAllMocks();
    mockStreamingConnections.length = 0;
