...
describe('agentContextsStore', () => {
    ...
    describe('removeRun', () => {
        ...
        it('should not clear selection if removing non-selected runContext', () => {
            const store = useAgentContextsStore();
            const configStore = useAgentRunConfigStore();
            const selectionStore = useAgentSelectionStore();
    ...
    describe('lockConfig', () => {
        it('should lock the configuration of an runContext', () => {
            const store = useAgentContextsStore();
            const configStore = useAgentRunConfigStore();
    ...
    describe('promoteTemporaryId', () => {
        it('should replace active runContext ID with permanent one', () => {
            const store = useAgentContextsStore();
            const configStore = useAgentRunConfigStore();
            const selectionStore = useAgentSelectionStore();
            ...
            expect(runContext?.config.agentDefinitionId).toBe('def-1');
            expect(runContext?.state.runId).toBe(permId);
    ...
    describe('activeRun getter', () => {
        it('should return the currently selected runContext', () => {
            const store = useAgentContextsStore();
            const configStore = useAgentRunConfigStore();
            const selectionStore = useAgentSelectionStore();
            ...
            expect(store.activeRun?.state.runId).toBe(id);
