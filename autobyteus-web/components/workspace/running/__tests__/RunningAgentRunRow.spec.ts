...
describe('RunningAgentRunRow', () => {
  ...
  it('renders run label with name and suffix', () => {
    const wrapper = mount(RunningAgentRunRow, {
      props: {
  ...
  it('shows status indicator', () => {
    const wrapper = mount(RunningAgentRunRow, {
      props: {
        runContext: { ...mockRunContext, state: { ...mockRunContext.state, currentStatus: AgentStatus.Error } } as any,
        isSelected: false,
      },
    });
