...
const pendingBootstrapEnvelope = shallowRef<ApplicationHostBootstrapEnvelope | null>(null)
...
const handleReady = (signal: ApplicationIframeReadySignal): void => {
  ...
  pendingBootstrapEnvelope.value = createApplicationHostBootstrapEnvelope({
    host: {
