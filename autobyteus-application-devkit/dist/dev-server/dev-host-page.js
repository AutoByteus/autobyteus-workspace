import { APPLICATION_IFRAME_BOOTSTRAP_EVENT, APPLICATION_IFRAME_CHANNEL, APPLICATION_IFRAME_CONTRACT_VERSION_V4, APPLICATION_IFRAME_READY_EVENT, APPLICATION_IFRAME_QUERY_APPLICATION_ID, APPLICATION_IFRAME_QUERY_CONTRACT_VERSION, APPLICATION_IFRAME_QUERY_HOST_ORIGIN, APPLICATION_IFRAME_QUERY_IFRAME_LAUNCH_ID, createApplicationHostBootstrapEnvelopeV4, } from '@autobyteus/application-sdk-contracts';
...
const encodeScriptJson = (value) => (JSON.stringify(value).replace(/</g, '\\u003c'));
...
export const renderDevHostPage = (session) => `<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
...
`;
//# sourceMappingURL=dev-host-page.js.map