...
const isBareRuntimeSpecifier = (specifier) => {
...
const assertBackendEntrySelfContained = async (entryPath) => {
    ...
    if (bareSpecifiers.length > 0) {
        throw new Error(`Backend entry contains non-bundled package imports: ${[...new Set(bareSpecifiers)].join(', ')}`);
    }
};
...
//# sourceMappingURL=backend-builder.js.map